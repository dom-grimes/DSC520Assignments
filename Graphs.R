...
## `height` vs. `earn`
ggplot(heights_df, aes(height, earn)) + geom_point()
## `age` vs. `earn`
ggplot(heights_df, aes(age, earn)) + geom_point()
## `ed` vs. `earn`
ggplot(heights_df, aes(ed, earn)) + geom_point()

## Re-create the three scatterplots and add a regression trend line using
## the `geom_smooth()` function
## `height` vs. `earn`
ggplot(heights_df, aes(height, earn)) + geom_point() + geom_smooth()
## `age` vs. `earn`
ggplot(heights_df, aes(age, earn)) + geom_point() + geom_smooth()
## `ed` vs. `earn`
ggplot(heights_df, aes(ed, earn)) + geom_point() + geom_smooth()

## Create a scatterplot of `height`` vs. `earn`.  Use `sex` as the `col` (color) attribute
ggplot(heights_df, aes(height, earn, col=sex)) + geom_point()
...
ggplot(heights_df, aes(height, earn, col=sex)) + 
  geom_point() + 
