...
## Assuming the week starts on Sunday, Tuesday is the third item in the vector.
week1_sleep[3]
...
week1_sleep_greater8 <- week1_sleep > 8
week1_sleep_greater8
sum(week1_sleep_greater8)
